...
export default function Signup(): React.ReactElement {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-emerald-50 via-blue-50 to-slate-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 py-12">
      <div className="max-w-md w-full mx-4">
        {/* Logo/Brand */}
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-emerald-500 to-blue-500 rounded-2xl mb-4 shadow-xl">
            <svg
          ...
          <p className="text-slate-600 dark:text-slate-400">Join Climatrix to track your climate impact</p>
        </div>
        ...
        >
          ...
          <div className="space-y-5">
            ...
            <div className="flex items-start gap-2 text-sm">
              <input type="checkbox" className="mt-1 rounded border-slate-300 dark:border-slate-600" required />
